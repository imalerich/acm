...
public class Collisions {
	...
	public static Integer numCollisions(Pair Q, ArrayList<Pair> queens, ArrayList<Integer> collisions, int n) {
		...
		if (Q0 >= 0 && collisions.get(Q0) == 0) { count++; }
		if (Q1 >= 0 && collisions.get(Q1) == 0) { count++; }
		if (Q2 >= 0 && collisions.get(Q2) == 0) { count++; }
		if (Q3 >= 0 && collisions.get(Q3) == 0) { count++; }
		if (Q4 >= 0 && collisions.get(Q4) == 0) { count++; }
		if (Q5 >= 0 && collisions.get(Q5) == 0) { count++; }
		if (Q6 >= 0 && collisions.get(Q6) == 0) { count++; }
		if (Q7 >= 0 && collisions.get(Q7) == 0) { count++; }
